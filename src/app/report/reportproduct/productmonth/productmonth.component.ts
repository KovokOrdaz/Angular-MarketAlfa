...
@Component({
  selector: 'app-productmonth',
  templateUrl: './productmonth.component.html',
  styleUrls: ['./productmonth.component.scss']
})
export class ProductmonthComponent implements OnInit {
  ...
  constructor(private api: ApibuyService, public apiBusiness: ApiBusinessService) {
    ...
    this.api.reportProductMounth().subscribe(x => {
      this.rows = x.data;
      this.temp = this.rows;
      this.single = [];
