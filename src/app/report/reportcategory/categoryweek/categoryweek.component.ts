...
@Component({
  selector: 'app-categoryweek',
  templateUrl: './categoryweek.component.html',
  styleUrls: ['./categoryweek.component.scss']
})
export class CategoryweekComponent implements OnInit {
  ...
  constructor(private api: ApibuyService, public apiBusiness: ApiBusinessService) {
    ...
    this.api.reportCategoryWeek().subscribe(x => {
      this.rows = x.data;
      this.temp = this.rows;
      this.single = [];
