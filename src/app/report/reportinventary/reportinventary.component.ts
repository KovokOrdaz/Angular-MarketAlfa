...
@Component({
  selector: 'app-reportinventary',
  templateUrl: './reportinventary.component.html',
  styleUrls: ['./reportinventary.component.scss']
})
export class ReportinventaryComponent implements OnInit {
  ngOnInit(): void {
  }
