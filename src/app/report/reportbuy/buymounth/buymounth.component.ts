...
@Component({
  selector: 'app-buymounth',
  templateUrl: './buymounth.component.html',
  styleUrls: ['./buymounth.component.scss']
})
export class BuymounthComponent implements OnInit {
  rows: any[] = [];
  ...
  createPDF() {
    ...
    html2canvas(DATA, options).then((canvas) => {
      ...
      docResult.save("Ventas_Del_Mes_MarketAlfa.pdf");
    });
  }
