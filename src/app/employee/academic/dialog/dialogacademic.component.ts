...
@Component({ templateUrl:'dialogacademic.component.html' })
export class DialogAcademicComponent
{
    public id: number = 0;
    ...
    constructor(public dialogRef: MatDialogRef<DialogAcademicComponent>, public api: ApiAcademicService, public snackBar: MatSnackBar, @Inject(MAT_DIALOG_DATA) public entity: Academic)
    {
        if(entity !== null)
        {
            this.id = entity.id; 
